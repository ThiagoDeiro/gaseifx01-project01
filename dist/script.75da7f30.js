...
m = n.getMonth() + 1;
d = n.getDate();
document.getElementById("date").innerHTML = weekday + " " + d + "/" + m + "/" + y; // function to update the image background!

function loadImg() {
  var pic = document.getElementById("firstImg");
  var date = new Date();
  var hour = date.getHours(); //var hour = 20;
...
displayList(taksList); //add new task
...
function displayList(array) {
  ...
  for (var i in array) {
    var checked = taksList[i].isDone ? 'checked' : '';
    var newData = "\n    <li class='list-group-item'>\n      <div>\n          <input ".concat(checked, " type=\"checkbox\" class = \"checkList\" />").concat(taksList[i].name, " \n      </div>\n      <div class = \"trashposition\">\n        <button class=\"trash\"><i class=\"far fa-trash-alt trash\" id=\"").concat(taksList[i].id, "\"></i>\n        </button>\n      </div>\n      <div class = \"editTask\">\n        <button id =\"edit\" class=\"edit\"><i class=\"fas fa-edit\" /></button>\n        <div class = \"editNewTask\" style=\"display: none;\">\n          <input class = \"editInpuValue\" type = \"text\"><button id=\"checKChange\"><i class=\"fas fa-check newItem \" id=\"edit_").concat(taksList[i].id, "\"/></button>\n        </div>\n      </div>\n    </li>\n        ");
